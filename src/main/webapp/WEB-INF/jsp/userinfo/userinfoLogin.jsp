                ...
                <form id="userLogin" action="/userinfo/login.do" method="post">
                    <div class="mb-3">
                        ...
                        <div class="input-group email-group">
                            <input type="text" class="form-control email-input" id="userEmail" name="userEmailId" maxlength="20" placeholder="이메일을 입력해주세요" value="${userEmailId}">
                            <span class="input-group-text">@</span>
                            <input type="text" class="form-control domain-input" id="userDomain" name="userDomain" maxlength="20" placeholder="도메인" value="${userDomain}">
