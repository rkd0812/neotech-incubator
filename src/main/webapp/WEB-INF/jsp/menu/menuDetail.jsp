...
<head>
    ...
    <script src="/app/js/menu/menuDetail.js"></script>
</head>
<body>
<h4>메뉴 상세</h4>
<div class="wrap" style="text-align: center;">
    <form id="detailForm" name="detailForm" action="/menu/update.do" method="post">
    ...
    <button id="listBtn" onclick=location.href="/menu/list.do">목록</button>
